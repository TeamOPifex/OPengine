...
### C/C++ Build Flags
if(${OPIFEX_OS_IOS})
	SET ( CMAKE_C_FLAGS "-stdlib=libstdc++ -mios-simulator-version-min=6.0 -fobjc-abi-version=2 -fobjc-arc -isysroot ${CMAKE_OSX_SYSROOT}" CACHE STRING "compile flags" FORCE)
	SET ( CMAKE_CXX_FLAGS "-stdlib=libstdc++ -mios-simulator-version-min=6.0 -std=c++11 -fobjc-abi-version=2 -fobjc-arc -std=gnu++11 -stdlib=libc++ -isysroot ${CMAKE_OSX_SYSROOT}" CACHE STRING "compile flags" FORCE)
