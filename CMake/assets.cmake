...
if( ${OPIFEX_OS_ANDROID} )
	...
	file(COPY ${PROJECT_SOURCE_DIR}/External/PhysX/Bin/android/libPhysX3Common.a 	DESTINATION 	${PROJECT_BINARY_DIR}/Binaries/android)
	file(COPY ${PROJECT_SOURCE_DIR}/External/PhysX/Bin/android/libPvdRuntime.a 	DESTINATION 	${PROJECT_BINARY_DIR}/Binaries/android)
	file(COPY ${PROJECT_SOURCE_DIR}/External/PhysX/Bin/android/libSimulationController.a 	DESTINATION 	${PROJECT_BINARY_DIR}/Binaries/android)
	file(COPY ${PROJECT_SOURCE_DIR}/External/PhysX/Bin/android/libSceneQuery.a 	DESTINATION 	${PROJECT_BINARY_DIR}/Binaries/android)
	file(COPY ${PROJECT_SOURCE_DIR}/External/PhysX/Bin/android/libLowLevel.a 	DESTINATION 	${PROJECT_BINARY_DIR}/Binaries/android)
	file(COPY ${PROJECT_SOURCE_DIR}/External/PhysX/Bin/android/libLowLevelCloth.a 	DESTINATION 	${PROJECT_BINARY_DIR}/Binaries/android)
	file(COPY ${PROJECT_SOURCE_DIR}/External/PhysX/Bin/android/libPhysX3.a 	DESTINATION 	${PROJECT_BINARY_DIR}/Binaries/android)
	file(COPY ${PROJECT_SOURCE_DIR}/External/PhysX/Bin/android/libPhysX3Vehicle.a 	DESTINATION 	${PROJECT_BINARY_DIR}/Binaries/android)
	file(COPY ${PROJECT_SOURCE_DIR}/External/PhysX/Bin/android/libPhysX3Cooking.a 	DESTINATION 	${PROJECT_BINARY_DIR}/Binaries/android)
	file(COPY ${PROJECT_SOURCE_DIR}/External/PhysX/Bin/android/libPhysX3Extensions.a 	DESTINATION 	${PROJECT_BINARY_DIR}/Binaries/android)
	file(COPY ${PROJECT_SOURCE_DIR}/External/PhysX/Bin/android/libPhysX3CharacterKinematic.a 	DESTINATION 	${PROJECT_BINARY_DIR}/Binaries/android)
	file(COPY ${PROJECT_SOURCE_DIR}/External/PhysX/Bin/android/libPhysXProfileSDK.a 	DESTINATION 	${PROJECT_BINARY_DIR}/Binaries/android)
	file(COPY ${PROJECT_SOURCE_DIR}/External/PhysX/Bin/android/libPxTask.a 	DESTINATION 	${PROJECT_BINARY_DIR}/Binaries/android)
	file(COPY ${PROJECT_SOURCE_DIR}/External/PhysX/Bin/android/libPhysXVisualDebuggerSDK.a 	DESTINATION 	${PROJECT_BINARY_DIR}/Binaries/android)
