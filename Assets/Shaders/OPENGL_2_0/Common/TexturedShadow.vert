...
void main(){
	...
	//FragPos
	vFragPos = vec3(uWorld * vec4(aPosition,1));

	// FragPosLightSpace
	vShadowCoord = uProjShadow * uViewShadow * uWorld * vec4(aPosition,1);

	// UV of the vertex. No special space for this one.
	vUV = aUV;

	// Get transpose(inverse(uWorld))
	mat3 w = m3(uWorld);
	mat3 ti = transpose(inverse(w));
	vNormal = w * aNormal;
}
