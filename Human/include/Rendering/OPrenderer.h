...
struct OPrenderer {
	...
	void(*_SubmitModelMaterial)(OPrenderer* renderer, OPmodel* model, OPmat4* world, bool shadowed, OPmaterialInstance* material) = 0;
	void(*_SubmitMeshMaterial)(OPrenderer* renderer, OPmesh* mesh, OPmat4* world, bool shadowed, OPmaterialInstance* material) = 0;
	...
	inline void Submit(OPmodel* model, OPmat4* world, bool shadowed, OPmaterialInstance* material) { _SubmitModelMaterial(this, model, world, shadowed, material); }
	inline void Submit(OPmesh* mesh, OPmat4* world, bool shadowed, OPmaterialInstance* material) { _SubmitMeshMaterial(this, mesh, world, shadowed, material); }
