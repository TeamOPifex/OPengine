...
// }
// inline void OPfontRender2D(const OPchar* text, OPvec3 color, OPvec2 pos) {
// 	OPfontRender2D(text, OPvec4Create(color, 1.0f), pos, OPFONTMANAGER_ACTIVE->_align);
// }
...
// }
// inline void OPfontRender2D(const OPchar* text, OPvec4 color, OPvec2 pos) {
// 	ASSERT(OPFONTMANAGER_ACTIVE != NULL, "A Font Manager has not been bound yet");
// 	OPfontRender2D(text, color, pos, OPFONTMANAGER_ACTIVE->_align);
// }
