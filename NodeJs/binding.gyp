    ...
    "targets": [
        {
            ...
            "sources": [
                 ...
                 "../OPengine/Scripting/src/Node/Human/OPATTRWrapper.cpp",
                 "../OPengine/Scripting/src/Node/Human/OPcamWrapper.cpp",
                 "../OPengine/Scripting/src/Node/Human/OPcubeWrapper.cpp",
                 "../OPengine/Scripting/src/Node/Human/OPeffectWrapper.cpp",
                 "../OPengine/Scripting/src/Node/Human/OPfontWrapper.cpp",
                 "../OPengine/Scripting/src/Node/Human/OPgamePadWrapper.cpp",
                 "../OPengine/Scripting/src/Node/Human/OPkeyboardWrapper.cpp",
                 "../OPengine/Scripting/src/Node/Human/OPmaterialWrapper.cpp",
                 "../OPengine/Scripting/src/Node/Human/OPmeshWrapper.cpp",
