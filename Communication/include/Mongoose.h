...
extern "C" {
	...
	typedef int(*mg_handler_t)(struct mg_connection *, enum mg_event, void* server_obj);
	...
	struct mg_server *mg_create_server(void *server_param, mg_handler_t handler, void* server_obj);
