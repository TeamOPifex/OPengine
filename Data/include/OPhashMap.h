...
*/
EXPORT_METHOD OPhashMap* OPhashMapCreate(OPuint capacity);

/* Destroys an OPhashMap
 * @param The OPhashMap to destroy
*/
EXPORT_METHOD void OPhashMapDestroy(OPhashMap* map);
...
*/
EXPORT_METHOD OPint OPhashMapGet(const OPhashMap* hashMap, const OPchar* key, void** value);
 ...
 * @return Success Result
*/
EXPORT_METHOD OPint OPhashMapExists(const OPhashMap* map, const OPchar* key);
 ...
 * @return Success Result
*/
EXPORT_METHOD OPint OPhashMapPut(OPhashMap* map, const OPchar* key, void* value);
...
*/
EXPORT_METHOD OPint OPhashMapCount(const OPhashMap* map);
